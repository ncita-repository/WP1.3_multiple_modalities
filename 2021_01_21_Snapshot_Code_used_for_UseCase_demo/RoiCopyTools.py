    ...
    **************************************************************************
    ...
    if UseCase in ['3a', '3b', '4', '5']:
        ...
        ***********************************************************************
        ...
        # 03/09/21 Convert PixArrToCopy to a labelmap image:
        LabmapImToCopy = PixArr2Image(PixArr=PixArrToCopy,
                                      FrameToSliceInds=[FromSliceNum],
                                      RefIm=SrcIm)
    ...
    **************************************************************************
    ...
    if UseCase in ['1a', '2a']:
        ...
        LabmapImToCopy = PixArr2Image(
            PixArr=TrgPixArr,
            FrameToSliceInds=TrgPFFGStoSliceInds,
            RefIm=SrcIm
            )
    ...
    if UseCase == '3a':
        ...
        # 03/09/21:
        from ConversionTools import ConvertImagePixelType
        TrgLabIm = PixArr2Image(
            PixArr=TrgPixArr, FrameToSliceInds=TrgPFFGStoSliceInds,
            RefIm=TrgIm
            )
...
def CopyRoi(SrcRoi, FromSearchString, SrcDcmDir, FromSliceNum, TrgDcmDir,
    ...
    if SrcModality == 'RTSTRUCT':
        ...
        """
        # 03/09/21:
        SrcDcmDir, TrgDcmDir, SrcIm, TrgIm, SrcSeg,\
        SrcLabIm, SrcPixArr, SrcF2SindsBySeg, SrcF2Sinds,\
        TrgLabIm, TrgPixArr, TrgF2Sinds,\
        RegIm, RegImFilt, TxParams, TrgSeg\
            = CopySeg(SrcRoi, FromSearchString, SrcDcmDir, FromSliceNum, 
                      TrgDcmDir, TrgRoi, ToSliceNum, Sigma, ThreshLevel,
                      AddText, LogToConsole)
...
def ErrorCheckRoi(Roi, DicomDir, LogToConsole=False):
    ...
    #Fpath = os.path.join(CWD, 'logs', Fname) # 03/09/21
    ...
    Fpath = os.path.join(exportDir, Fname) # 03/09/21
