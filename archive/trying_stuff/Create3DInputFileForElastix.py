...
"""
Function:
    Create3DInputFileForElastix()
    
Purpose:
    Create a text file containing 3D points for Elastix's Transformix to deform.
...
def Create3DInputFileForElastix(DicomDir, RoiFpath):
    # Import packages:
    import pydicom
    ...
    ContourPts = Get3DContourPointsFromDicoms(DicomDir, RoiFpath)
