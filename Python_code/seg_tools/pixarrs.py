...
from seg_tools.metadata import get_frame_nums, get_PFFGS_to_sliceindsBySeg
...
def get_pixarr_in_seg(seg, dicomDir, searchStr):
    ...
    PFFGStoSliceIndsInSeg : list of ints
    ...
    frameNumsInSeg, PFFGStoSlcIndsInSeg = get_frame_nums(seg, searchStr, 
                                                           dicomDir)
    ...
    return pixarrInSeg, PFFGStoSlcIndsInSeg
...
def get_pixarr_in_seg_OLD(seg, dicomDir, searchStr):
    ...
    # segment of interest, and the corresponding Per-frame Functional Groups
    # Sequence-to-slice indices:
    frameNumsInSeg, PFFGStoSliceIndsInSeg = get_frame_nums(seg, searchStr, 
                                                           dicomDir)
...
def get_pixarrBySeg_OLD(seg, dicomDir, p2c=False):
    ...
    f2sIndsBySeg = get_PFFGS_to_sliceindsBySeg(seg, SOPUIDs)
