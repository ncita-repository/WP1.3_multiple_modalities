...
def are_inputs_valid(params, trgRoiNames):
    """
...
def which_use_case_OLD(srcSlcNum, trgSlcNum, srcDcmDir, trgDcmDir, forceReg, 
                   p2c=False):
    """
...
def which_use_case(srcXnatParams, trgXnatParams, resParams, genParams):
    """
    Determine which of 5 Use Cases applies.
