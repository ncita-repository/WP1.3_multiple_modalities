...
S011_MR4_S3_DicomDir = os.path.join(DicomRootDir, MR4Dir,
                                    r"3-T2 TSE AXIAL-07507") # 

S011_MR4_S4_DicomDir = os.path.join(DicomRootDir, MR4Dir,
                                    r"4-T2 AXIAL FLAIR DARK FL-48830") # 416x512x21 .449x.449x5 mm

S011_MR4_S5_DicomDir = os.path.join(DicomRootDir, MR4Dir,
                                    r"5-T1 SE AXIAL 3MM-81246")        # 208x256x50 .898x.898x3 mm

S011_MR4_S6_DicomDir = os.path.join(DicomRootDir, MR4Dir, 
                                    r"6-ep2ddiff3scantracep2-55446") # 192x192x63 1.302x1.302x5 mm

S011_MR4_S7_DicomDir = os.path.join(DicomRootDir, MR4Dir, 
                                    r"7-ep2ddiff3scantracep2ADC-22197") # 

S011_MR4_S8_DicomDir = os.path.join(DicomRootDir, MR4Dir, 
                                    r"8-T1 SE AXIAL POST FS FC-59362") # 212x256x30 .898x.898x5 mm

S011_MR4_S9_DicomDir = os.path.join(DicomRootDir, MR4Dir,
                                    r"9-T1 SE AXIAL POST 3MM 5 MIN DELAY-07268") # 208x256x50 .898x.898x3 mm

S011_MR12_S8_DicomDir = os.path.join(DicomRootDir, MR12Dir,
...
S011_MR4_S8_RtsFpath = os.path.join(RtsRootDir, "MR4_S8_tumour_RTS_AIM_20200511_073405.dcm") # tumour
S011_MR4_S8_SegFpath = os.path.join(SegRootDir, "Seg_from_MR4_S8_tumour_RTS_AIM_20200511_073405.dcm") # tumour

S011_MR4_S9_RtsFpath = os.path.join(RtsRootDir, "MR4_S9_tumour_RTS_AIM_20201014_163721.dcm") # tumour drawn on S9 stack
S011_MR4_S9_SegFpath = os.path.join(SegRootDir, "Seg_from_MR4_S9_tumour_RTS_AIM_20201014_163721.dcm") # tumour drawn on S9 stack

S011_MR4_S5_RtsFpath = os.path.join(RtsRootDir, "MR4_S5_tumour_RTS_AIM_20201021_151904.dcm") # tumour drawn on S5 stack
S011_MR4_S5_SegFpath = os.path.join(SegRootDir, "Seg_from_MR4_S5_tumour_RTS_AIM_20201021_151904.dcm") # tumour drawn on S5 stack

S011_MR4_S3_RtsFpath = os.path.join(RtsRootDir, "") 
S011_MR4_S3_SegFpath = os.path.join(SegRootDir, "MR4_S3_brain_SEG_20201030_133110.dcm")
...
for i in range(len(S011_MR4_DicomDirs)):
    ...
    Size, Spacings, Positions, Dirs = GetImageAttributes(S011_MR4_DicomDirs[i], Package, LogToConsole)
...
SrcLabMapIm, ResSrcLabMapIm,TrgLabMapIm = MappedCopySegmentAcrossSeries(SrcDcmDir=S011_MR4_S9_DicomDir, 
                                            SrcSegFpath=S011_MR4_S9_SegFpath, 
                                            FromSliceNum=28,
                                            TrgDcmDir=S011_MR4_S3_DicomDir, 
                                            TrgSegFpath=S011_MR4_S3_SegFpath,
...
# # Need to figure out why the resampled Source LabelMap image has new labels (5) despite using NearestNeighbour interpolator...
# 
