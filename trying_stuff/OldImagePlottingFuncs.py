# -*- coding: utf-8 -*-
"""
Created on Tue Sep  8 15:25:33 2020
...
def display_all_sitk_images_and_reg_results_with_all_contours_v3(fix_im, 
                                                                 mov_im, 
                                                                 reg_im,
                                                                 fix_pts, 
                                                                 mov_pts,
    ...
    # The number of contours in fix_pts and mov_pts:
    fix_Ncontours = 0
    mov_Ncontours = 0
