...
def RemapDicoms(PreRemappedDicoms, DataDict):
    ...
    PreRemappedScanPos = DataDict[ToRemapKey]['ScanPos']
    ...
    if 'Source' in ToRemapKey:
        ...
        MappingInds = DataDict['TargetToSourceNearOnly']['MappingInds']
    else:
        #MappingInds = DataDict['SourceToTargetMapping']['MappingInds']
        MappingInds = DataDict['SourceToTargetNearOnly']['MappingInds']
